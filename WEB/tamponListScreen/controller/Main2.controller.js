sap.ui.define(
	...
	function (
		...
		"use strict";
		var BATCH, HANDLE, ROW_NUMBER, SAMPLE_TIME, oRouter, OPERATION;

		return Controller.extend("tamponListScreen.controller.Main2", {
			onInit: function () {
				oRouter = sap.ui.core.UIComponent.getRouterFor(this);
				oRouter.getRoute("RouteMain2").attachPatternMatched(this._onRoute, this);
			},
			...
			getDialog: function () {
				if (!this.oDialog) {
					this.oDialog = sap.ui.xmlfragment("logResults_Fragment", "tamponListScreen.view.fragments.logResults_Fragment", this);
