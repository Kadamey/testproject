    ...
    function (
                        ...
                        for (i = 0; i < machineGroupsLength; i++) {
                            if (
                                ...
                                oEvent
                                    .getSource()
                                    .getBindingContext()
                                    .getObject().machineGroup.machineGroup
                            ) {
		...
		*/
            ...
            sap.ui.core.Fragment.byId("downtimeDialog", "MultiPMNotificationType").setVisible(false);
                ...
                initializeDowntimeDialog: function () {
                    if (this.oDowntimeDialog == undefined) {
                        ...
                        this.byId(
                            sap.ui.core.Fragment.createId("downtimeDialog", "endTime")
                        );
                        this.byId(
                            sap.ui.core.Fragment.createId("downtimeDialog", "startDate")
                        );
                        this.byId(
                            sap.ui.core.Fragment.createId("downtimeDialog", "endDate")
                        );
                        this.byId(
                            sap.ui.core.Fragment.createId(
                                "downtimeDialog",
			...
			sap.ui.core.Fragment.byId("downtimeDialog", "downtimeDialog").setContentHeight("52%");
					...
					*/
                    sap.ui.core.Fragment.byId("downtimeDialog", "checkPMNotification").setSelected(true);
                    sap.ui.core.Fragment.byId("downtimeDialog", "checkPMNotification").setEnabled(false);
                    ...
                    var oDialog = new Dialog({
                        ...
                        beginButton: new Button({
                            ...
                            press: function () {
                                ...
                                var referanceNotificationId = sap.ui.getCore().byId('inputBox1').getValue();
                                if (referanceNotificationId == "") {
                                    alert("Referans Numarası Giriniz.");
                                    return;
                                } that.onPressReportNotification_Enhancement(referanceNotificationId);
