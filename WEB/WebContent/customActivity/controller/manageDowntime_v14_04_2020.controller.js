		...
		*/
			...
			details.push({label : this.appComponent.oBundle.getText("OEE_LABEL_IMPACTS_LINE"), value : this.appComponent.oBundle.getText("OEE_LABEL_NO")});
				...
				setDialogInputs_Enhancement: function () {
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "workunitforDowntime").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "TypeforDowntime").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "reasonCode").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "microStoppageLabel").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "startTimeLabel").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "durationforDowntime").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "frequencyLabel").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "endTimeLabel").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "crewSize").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "standardDuration").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "fromMaterial").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "toMaterial").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "bottleneckForDowntimeLabel").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "assignToOrderLabel").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "reportPMNotification").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "functionalLocation").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "equipment").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "SinglePMNotificationType").setVisible(false);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "MultiPMNotificationType").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "breakDown").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "commentsForDowntime").setVisible(true);
					sap.ui.core.Fragment.byId("Z_DowntimeDialog", "idPMWorkCenter").setVisible(true);
				...
				onPressReportNotification_Enhancement: function (iv_reference) {
                    ...
                    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    //Submit butonuna basınca kesinti ve bildirim türünün otomatik gelmesini sağlar.-DAMLAB-1404
                        sap.ui.core.Fragment.byId(
                            "Z_DowntimeDialog",
                            "checkPMNotification"
                        ).setSelected(true);
					...
					var oDialog = new Dialog({
						...
						beginButton: new Button({
							...
							press: function () {
								...
								if (referanceNotificationId == "") {
									alert("Referans Numarası Giriniz.");
									return;
								}
								that.onPressReportNotification_Enhancement(
									referanceNotificationId
								);
						...
						getPMNotification: function (input1) {
							...
							var response = TransactionCaller.async(
								"ItelliMES/UI/PERSONNEL_SHIFT_SCREEN/T_PM_NOTIFICATION",
						...
						getPMNotificationCB: function (iv_data, iv_scope) {
							alert(iv_data[0]);
						//	sap.ui.core.Fragment.byId("fragmanetadı","alanınid").setValue(iv_data[0].Rowsets.Rowset.ROw.ekipmanID)
