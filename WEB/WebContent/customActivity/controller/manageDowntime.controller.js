sap.ui.define(
    ...
    function (
        ...
        return Controller.extend(
            "customActivity.controller.manageDowntime",

            {
                ...
                populateRootCauseDowntimeTable: function () {
                    ...
                    if (
                        ...
                        if (aggregatedDataJSON.ioDowntimeList.results.length != 0) {
                            ...
                            $.each(aggregatedDataJSON.ioDowntimeList.results, function (
                                index,
                                obj
                            ) {
                    ...
                    if (
                        ...
                        $.each(this.plantHierarchyNodesList, function (index, obj) {
                            ...
                            if (
                                ...
                                $.each(selectedDown.rootcauseMachines.results, function (
                                    index,
                                    obj2
                                ) {
                        ...
                        if (oRootCauseMachineTable.getModel() != undefined) {
                            ...
                            rootCauseMachinesListModel = new sap.ui.model.json.JSONModel();
                ...
                onClickOpenReasonCodeUtilityPopupFromRootCauseDialog: function (
                    oEvent
                ) {
                ...
                bindDtListModes: function () {
                    ...
                    if (
                        ...
                        validModes.dtListModes = $.grep(validModes.dtListModes, function (
                            element,
                            elementIndex
                        ) {
                                ...
                                if (
                                    ...
                                    for (
                                        ...
                                        if (
											...
											// Kaan Adamey - Enhancement PM notif button removal. PM notifs will only be created while declaring a downtime.
											//this.byId("reportButtonForNotification").setVisible(true);
											this.byId("reportButtonForNotification").setVisible(false);
                                            this.byId("reportButtonForNotification").setEnabled(
                                                false
                                            );
                                            ...
                                            this.byId("reportButtonForNotification").setVisible(
                                                false
                                            );
                                            sap.ui.core.Fragment.byId(
                                                "Z_DowntimeDialog",
                ...
                addDownsToModel: function (downEvents) {
                    if (
                        ...
                        if (downEvents.ioDowntimeList.results.length != 0) {
                            ...
                            for (
                                var i = 0;
                                i < downEvents.ioDowntimeList.results.length;
                                i++
                            ) {
                ...
                lineDownsLoaded: function (aggregatedDataJSON) {
                    ...
                    if (
                        ...
                        for (var i = 0; i < lineDownList.length; i++) {
                            lineDownList[i].notificationIcon = null;
                            if (
                                lineDownList[i].ioProductionRunDowntime
                                    .associatedPMNotifications.results.length > 0
                            ) {
                                lineDownList[i].notificationIcon = "sap-icon://notification";
                            } else {
                    ...
                    if (
                        ...
                        if (outputOrderStatusList != undefined) {
                            if (outputOrderStatusList.orderStatusList != undefined) {
                                if (
                                    outputOrderStatusList.orderStatusList.results != undefined
                                ) {
                                    if (
                                        outputOrderStatusList.orderStatusList.results.length != 0
                                    ) {
                                        if (this.orderReferences != undefined) {
                                            for (
                                                var i = 0;
                                                i <
                                                outputOrderStatusList.orderStatusList.results.length;
                                                i++
                                            ) {
                                                for (
                                                    var j = 0;
                ...
                validateInputAndOverallSplitDuration: function (oEvent) {
                    ...
                    control
                        .getBindingContext()
                        .getObject().duration = oEvent.getParameter("newValue");
                    var sVal = oEvent.getParameter("newValue");
                    var fVal = new Number(0);
                    if (sVal == "") {
                        control.setValueState(sap.ui.core.ValueState.None);
                    ...
                    var oOKButton = sap.ui
                        .getCore()
                        .byId(
                            sap.ui.core.Fragment.createId("splitEventsPopup", "okButton")
                        );
                ...
                reportBreakdownEvents: function () {
                    ...
                    if (this.breakdownEventsToBeReported != undefined) {
                        if (this.breakdownEventsToBeReported.length > 0) {
                            for (
                                var i = 0;
                                i < this.breakdownEventsToBeReported.length;
                                i++
                            ) {
                                if (
                                    this.breakdownEventsToBeReported[i].duration != "" &&
                                    ...
                                    if (
                                        ...
                                        sap.oee.ui.oeeConstants.dtTypes.MINOR
                                    ) {
                    ...
                    if (
                        downtimeToBeCreated.length > 0 &&
                        downtimeToBeDeleted.length > 0
                    ) {
                ...
                rootCauseMachineButtonFormatter: function (obj1, ioProdDowntime) {
                    ...
                    if (
                        ...
                        if (rootCauseExistCheck) {
                            ...
                            //Associated Events
                            return ioProdDowntime.associatedProductionEvents.results.length >
                                1
                                ? this.appComponent.oBundle.getText("OEE_LABEL_MULTIPLE")
                ...
                showEventsComprisingMicroStoppages: function (oEvent) {
                    ...
                    if (eventsData.events.length > 100) {
                        eventsModel.setSizeLimit(eventsData.events.length);
                    }
                ...
                initializeDownTime: function () {
                    ...
                    if (this.dataCollectionElementsList != undefined) {
                        for (var i = 0; i < this.dataCollectionElementsList.length; i++) {
                            if (
                                this.dataCollectionElementsList[i]
                                    .defaultDataCollectionElement == true
                            ) {
                    ...
                    if (this.oWorkUnitDialog == undefined) {
                            ...
                            if (this.appData.selected.runID != undefined) {
                                ...
                                if (this.dcElementList.dataCollectionElements != undefined) {
                                    for (
                                        var i = 0;
                                        i <
                                        this.dcElementList.dataCollectionElements.results.length;
                                        i++
                                    ) {
                                        if (
                                        ...
                                        $.each(phNodesData.details.results, function (index, obj) {
                                            ...
                                            if (obj.assignedMachineGroup != undefined) {
                                                if (
                                                    ...
                                                    $.each(obj.assignedMachineGroup.results, function (
                                                        index1,
                                                        obj1
                                                    ) {
                                                        var matchedList = $.grep(matgroups, function (
                                                            element,
                                                            elementindex
                                                        ) {
                                                            if (
                        ...
                        if (this.plantHierarchyNodesList !== undefined) {
                            ...
                            for (var i = 0; i < getNodeAndChildrenDetails.length; i++) {
                                ...
                                workUnitTemp.bottleNeck =
                                    getNodeAndChildrenDetails[i].bottleNeck;
                                workUnitTemp.capacityID =
                                    getNodeAndChildrenDetails[i].capacityID;
                                workUnitTemp.isCapacity =
                                    getNodeAndChildrenDetails[i].isCapacity;
                        ...
                        if (bConfirm == sap.m.MessageBox.Action.OK) {
                            ...
                            if (response != undefined) {
                                if (response.outputCode == 0) {
                                    sap.oee.ui.Utils.toast(
                                        oController.appComponent.oBundle.getText(
                                            "OEE_LABEL_DELETED"
                                        )
                                    );

                                    oDetailsTable.removeSelections(true);
                                    var matchedList = $.grep(data.aggregatedDowns, function (
                                        element,
                                        elementindex
                                    ) {
                                        var i;
                    ...
                    if (
                        ...
                        if (this.machineGroups != undefined) {
                            ...
                            if (
                                ...
                                var workUnits = this.workUnitData;
                                this.oModel.setData({
                                    modelData: workUnits,
                                });
                    ...
                    if (srcType == "Active") {
                        ...
                        for (i = 0; i < machineGroupsLength; i++) {
                            if (
                                ...
                                var getNodeAndChildrenDetails = this.machineGroups[i]
                                    .machineGroup.nodes;
                                this.oInfo.setText(
                ...
                onChangeType: function (oEvent) {
                    ...
                    /*if(sap.ui.core.Fragment.byId("Z_DowntimeDialog", "typeforDowntime").getSelectedKey() === sap.oee.ui.oeeConstants.dcElementType.unplanned || 
                     sap.ui.core.Fragment.byId("Z_DowntimeDialog", "typeforDowntime").getSelectedKey() === sap.oee.ui.oeeConstants.dcElementType.changeover){
                         this.downtimeData.crewSize = sap.ui.core.Fragment.byId("Z_DowntimeDialog", "crewSizeforDowntime").getValue();
                  }
                      
                  if(sap.ui.core.Fragment.byId("Z_DowntimeDialog", "typeforDowntime").getSelectedKey() === sap.oee.ui.oeeConstants.dcElementType.planned){
                      this.downtimeData.standardDuration = sap.ui.core.Fragment.byId("Z_DowntimeDialog", "standardDurationforDowntime").getValue(); 
                  }
                  */
                    ...
                    /*if (sap.ui.core.Fragment.byId("Z_DowntimeDialog", "checkPMNotification").getSelected() == true) {
                      sap.ui.core.Fragment.byId("Z_DowntimeDialog", "functionalLocation").setVisible(true);
                      sap.ui.core.Fragment.byId("Z_DowntimeDialog", "equipment").setVisible(true);
                      sap.ui.core.Fragment.byId("Z_DowntimeDialog", "breakDown").setVisible(true);
          
                      if (this.notificationType && this.notificationType.length > 0) {
                          if (this.notificationType.length === 1) {
                              sap.ui.core.Fragment.byId("Z_DowntimeDialog", "SinglePMNotificationType").setVisible(true);
                              sap.ui.core.Fragment.byId("Z_DowntimeDialog", "MultiPMNotificationType").setVisible(false);
                              this.notificationData.notificationType = this.notificationType[0].value;
                          } else {
                              sap.ui.core.Fragment.byId("Z_DowntimeDialog", "SinglePMNotificationType").setVisible(false);
                              sap.ui.core.Fragment.byId("Z_DowntimeDialog", "MultiPMNotificationType").setVisible(true);
                              sap.ui.core.Fragment.byId("Z_DowntimeDialog", "MultiValue").setSelectedKey(this.notificationType[0].value);
                      ...
                      sap.ui.core.Fragment.byId("Z_DowntimeDialog", "functionalLocation").setVisible(false);
                      sap.ui.core.Fragment.byId("Z_DowntimeDialog", "equipment").setVisible(false);
                      sap.ui.core.Fragment.byId("Z_DowntimeDialog", "SinglePMNotificationType").setVisible(false);
                      sap.ui.core.Fragment.byId("Z_DowntimeDialog", "breakDown").setVisible(false);
                      sap.ui.core.Fragment.byId("Z_DowntimeDialog", "MultiPMNotificationType").setVisible(false);
                  }*/
                    ...
                    // if(sap.ui.core.Fragment.byId("Z_DowntimeDialog", "typeforDowntime").getSelectedKey() === sap.oee.ui.oeeConstants.dcElementType.changeover){
                    if (
                        this.downtimeData.eventType ===
                        sap.oee.ui.oeeConstants.timeElementTypes.changeOver
                    ) {
                ...
                handleOKForWorkunitDialog: function (oEvent) {
                    if (this.workUnitCapacitiesSelection) {
                        ...
                        var nodeDataList = [];
                        if (
                            oEvent.getSource().getBindingContext().getObject() != undefined
                        ) {
                            var nodeDataTemp = {};
                ...
                initializeDowntimeDialog: function () {
                    if (this.oDowntimeDialog == undefined) {
                        this.oDowntimeDialog = sap.ui.xmlfragment(
                            "Z_DowntimeDialog",
                            "customActivity.view.fragments.Z_DowntimeDialog",
                            this
                        );
                        this.byId(
                            sap.ui.core.Fragment.createId("Z_DowntimeDialog", "startTime")
                        );
                        this.byId(
                            sap.ui.core.Fragment.createId("Z_DowntimeDialog", "endTime")
                        );
                        this.byId(
                            sap.ui.core.Fragment.createId("Z_DowntimeDialog", "startDate")
                        );
                        this.byId(
                            sap.ui.core.Fragment.createId("Z_DowntimeDialog", "endDate")
                        );
                        this.byId(
                            sap.ui.core.Fragment.createId(
                                "Z_DowntimeDialog",
                        ...
                        sap.ui.core.Fragment.byId("Z_DowntimeDialog", "endTime").setEnabled(
                            true
                        );
                        sap.ui.core.Fragment.byId(
                            "Z_DowntimeDialog",
                        ...
                        sap.ui.core.Fragment.byId("Z_DowntimeDialog", "endDate").setEnabled(
                            true
                        );
                        sap.ui.core.Fragment.byId(
                            "Z_DowntimeDialog",
                ...
                handleOkForReasonCodeDialog: function () {
                    ...
                    this.PMNotification.notificationTypes = this.notificationType;
					   		...
					   		// Kaan Adamey 28.09.2020
							   var z_pmWorkcenterResult = TransactionCaller.sync(
								"ItelliMES/UI/MANAGE_DOWNTIME/T_GetPMWorkcenterList",
								{
									I_PPWORKCENTER: this.appData.node.description
								},
								"O_PMWORKCENTERLIST"
							);
							if(z_pmWorkcenterResult[1] == "S") {
							this.PMNotification.z_pmWorkcenterList = z_pmWorkcenterResult[0];
							}
                ...
                onPressClearDatesAndDuration: function (oEvent) {
                    ...
                    sap.oee.ui.Utils.calculateStartAndEndDatesWithDuration(
                        this.downtimeData,
                        sap.ui.core.Fragment.byId("Z_DowntimeDialog", "startDate"),
                        sap.ui.core.Fragment.byId("Z_DowntimeDialog", "startTime"),
                        sap.ui.core.Fragment.byId("Z_DowntimeDialog", "endDate"),
                        sap.ui.core.Fragment.byId("Z_DowntimeDialog", "endTime"),
                        sap.ui.core.Fragment.byId(
                            "Z_DowntimeDialog",
                            "durationforDowntime"
                        ),
                ...
                handleOkForDowntimeDialog: function () {
                    if (this.downtimeData != undefined) {
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (this.downtimeMode == "Edit") {
                                        ...
                                        //dbilgin-editledikten sonra MPM_PMNOTIFY_HDR Tablosunun güncellenmesi için eklendi.
                                        var pmWorkCenter = sap.ui.core.Fragment.byId(
                                            "Z_DowntimeDialog",
                                            "MultiValueWorkCenter"
                                        ).getSelectedKey();
                                        var nodeId = this.downtimeData.nodeDataList[0].nodeID;
                                        var endtime = this.oDowntimeReportingModel.getProperty("/typeforDowntime");
                                        ...
                                        var oeeNotifID = this.selectedDowntime.ioProductionRunDowntime.associatedPMNotifications.results[0].oeeNotificationID;
                                        var actsBreakDown = this.PMNotification.actsAsBreakdown;
                                        ...
                                        results = TransactionCaller.sync(
                                            "ItelliMES/UI/MANAGE_DOWNTIME/T_UPDATE_PMNOTIFY_HDR",
                                            {
                                                I_ACTASBREAKDOWN: actsBreakDown,
                                                I_CLIENT: downtimeDataTemp.client,
                                                I_COMMENTS: downtimeDataTemp.comments,
                                                I_DCELEMENT: downtimeDataTemp.dcElement,

                                                //I_ENTRYTYPE: downtimeDataTemp.entryType,
                                                I_NODEID: downtimeDataTemp.nodeID,
                                                I_NOTIFTYPE: downtimeDataTemp.notificationType,
                                                I_PLANT: downtimeDataTemp.plant,
                                                I_PMWORKCENTER: pmWorkCenter,
                                                I_RC1: downtimeDataTemp.rc1 || "",
                                                I_RC10: downtimeDataTemp.rc10 || "",
                                                I_RC2: downtimeDataTemp.rc2 || "",
                                                I_RC3: downtimeDataTemp.rc3 || "",
                                                I_RC4: downtimeDataTemp.rc4 || "",
                                                I_RC5: downtimeDataTemp.rc5 || "",
                                                I_RC6: downtimeDataTemp.rc6 || "",
                                                I_RC7: downtimeDataTemp.rc7 || "",
                                                I_RC8: downtimeDataTemp.rc8 || "",
                                                I_RC9: downtimeDataTemp.rc9 || "",
                                                I_OEE_NOTIF_ID: oeeNotifID,
                                                I_TECHNICALOBJECT: JSON.stringify(
                                                    downtimeDataTemp.technicalObject
                                                ),
                                                I_STARTTIMESTAMP: !!downtimeDataTemp.startTimestamp
                                                ? new Date(
                                                    downtimeDataTemp.startTimestamp
                                                ).toISOString()
                                                : "",
                                                I_ENDTIMESTAMP: !!downtimeDataTemp.endTimestamp
                                                ? new Date(
                                                    downtimeDataTemp.endTimestamp
                                                ).toISOString()
                                                : "",
                                            },
                                            "O_JSON"
                                ...
                                // var startTime = sap.ui.core.Fragment.byId("Z_DowntimeDialog", "startTime").getDateValue();
                                if (startTime != undefined && startTime != "") {
                                    ...
                                    // var endTime = sap.ui.core.Fragment.byId("Z_DowntimeDialog", "endTime").getDateValue();
                                    ...
                                    if (this.downtimeMode == "Edit") {
                                        ...
                                        if (
                                            ...
                                            /*
                                                                  ...
                                                                  */
                                            //debugger; // OEE NOTIFID ALINMASI SAGLANDI.
                                            var pmWorkCenter = sap.ui.core.Fragment.byId(
                                                "Z_DowntimeDialog",
                                                "MultiValueWorkCenter"
                                            ).getSelectedKey();
                                            ...
                                            results = TransactionCaller.sync(
                                                "ItelliMES/UI/MANAGE_DOWNTIME/T_CREATE_PM_DOWNTIME",
                                                {
                                                    I_ACTASBREAKDOWN: downtimeDataTemp.breakdown,
                                                    I_CLIENT: downtimeDataTemp.client,
                                                    I_COMMENTS: downtimeDataTemp.comments,
                                                    I_DCELEMENT: downtimeDataTemp.dcElement,
                                                    I_ENDTIMESTAMP: !!downtimeDataTemp.endTimestamp
                                            ...
                                            /*
                                                                  results = this.interfaces.createPMNotification(
                                                                      ...
                                                                      notifDataTemp.plant,
                                                                      downtimeDataTemp.nodeID, //notifDataTemp.nodeID,
                                            ...
                                            // results = this.interfaces.createPMNotification(downtimeDataTemp.client,
                                            // 	downtimeDataTemp.plant,
                                            // 	 downtimeDataTemp.nodeID,
                                            // 	downtimeDataTemp.startTimestamp,
                                            // 	downtimeDataTemp.endTimestamp,
                                            // 	downtimeDataTemp.technicalObject,
                                            // 	downtimeDataTemp.notificationType,
                                            // 	downtimeDataTemp.breakdown,
                                            // 	downtimeDataTemp.comments,
                                            // 	"false",
                                            // 	"");

                                            // results = this.interfaces.createPMNotification(
                                            //     downtimeDataTemp.client,
                                            // 	downtimeDataTemp.plant,
                                            // 	 downtimeDataTemp.nodeID,
                                            // 	downtimeDataTemp.technicalObject,
                                            // 	downtimeDataTemp.notificationType,
									  ...
									  sap.oee.ui.Utils.createMessage(results.outputMessage, sap.ui.core.MessageType.Error);
                                                ...
                                                this.downtimeData.endTimeStamp = endtimeStampTemp;
												this.downtimeData.startTimeStamp = startTimeStampTemp;
												//MessageToast.show(results[0]);
                                                sap.oee.ui.Utils.createMessage(results[0], sap.ui.core.MessageType.Error);
                                            }
                                        }
                                    }
                                } else {
                            ...
                            //endtime kontrolü ve update damlab-1908
                            // var endTimeStamp = this.oDowntimeReportingModel.getProperty("/endTime");
                            // var nodeId = this.downtimeData.nodeDataList[0].nodeID;


                            // var response = TransactionCaller.sync(
                            //	"ItelliMES/UI/MANAGE_DOWNTIME/T_UPDATE_PM_NOTIFICATION",
                            //	{
                            //	  I_NODEID :nodeId,  
                            //	  I_ENDTIMESTAMP: endTimeStamp,
                ...
                onDowntimeSelect: function (oEvent) {
                    ...
                    if (this.setSelectedMode == sap.oee.ui.oeeConstants.dtTypes.MINOR) {
                        ...
                        if (
                            this.setSelectedMode ==
                            sap.oee.ui.oeeConstants.dtTypes.OVERLAPPING
                        ) {
			  ...
			  sap.ui.core.Fragment.byId("Z_DowntimeDialog", "startTime").setEnabled(true);
			  sap.ui.core.Fragment.byId("Z_DowntimeDialog", "endTime").setEnabled(true);
			  sap.ui.core.Fragment.byId("Z_DowntimeDialog", "durationforDowntime").setEnabled(true);
			  sap.ui.core.Fragment.byId("Z_DowntimeDialog", "setCurrentForStartTime").setEnabled(true);
			  sap.ui.core.Fragment.byId("Z_DowntimeDialog", "setCurrentForEndTime").setEnabled(true);
		  }*/
                    ...
                    if (
                        this.selectedDowntime.ioProductionRunDowntime.actsAsBottleneck ==
                        "F"
                    ) {
                        this.downtimeData.actsAsBottleneck = false;
                    } else {
                    ...
                    if (
                        ...
                        if (
                            this.selectedDowntime.ioProductionRunDowntime.toMaterial !== ""
                        ) {
					...
					//Kaan Adamey 28.09.2020
					this.resetStartEndTimeStamp();
					this.setDialogInputs_Enhancement();
                },
                ...
                ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                //Z_DowntimeDialog fragmentinin açıldıktan sonra inputların gözükmesi/saklanmasını sağlar. DamlaB
                setDialogInputs_Enhancement: function () {
                    sap.ui.core.Fragment.byId(
                        "Z_DowntimeDialog",
                        "workunitforDowntime"
                    ).setVisible(true);
                    ...
                    sap.ui.core.Fragment.byId("Z_DowntimeDialog", "crewSize").setVisible(
                        false
                    );
                    sap.ui.core.Fragment.byId(
                        "Z_DowntimeDialog",
                    ...
                    sap.ui.core.Fragment.byId("Z_DowntimeDialog", "equipment").setVisible(
                        true
                    );
                    sap.ui.core.Fragment.byId(
                        "Z_DowntimeDialog",
                    ...
                    sap.ui.core.Fragment.byId("Z_DowntimeDialog", "breakDown").setVisible(
                        true
                    );
                    sap.ui.core.Fragment.byId(
                        "Z_DowntimeDialog",
                ...
                handleOKForFLDialog_Enhancement: function (oEvent) {
                    ...
                    if (this.downWithNotif === "X") {
                        ...
                        ///damla
                        //this.notificationData.fLocation = this.referencePMData.flocID;
                        //this.notificationData.equipment = this.referencePMData.equipmentID;
                        //sap.ui.core.Fragment.byId(
                        //	"Z_DowntimeDialog",
                        //	"functionalLocation"
                        //).setText(this.selectedDowntime.technicalObject[i].flocID);
                        ...
                        if (
                            ...
                            isNaN(startTimeDown) !== true &&
                            isNaN(endTimeDown) !== true
                        ) {
                        ...
                        if (this.reportNotificationMode === "UPDATE") {
                            this.oPMNotificationDialog.setTitle(
                                this.appComponent.oBundle.getText(
                                    "OEE_LABEL_UPDATE_NOTIFICATION"
                                )
                            );
                        } else {
                            this.oPMNotificationDialog.setTitle(
                                this.appComponent.oBundle.getText(
                                    "OEE_LABEL_CREATE_NOTIFICATION"
                                )
                            );
                        }
                ...
                onPressReportNotification_Enhancement: function (iv_reference) {
                    //parametre doluysa referans girmiştir. Değerlerin bazıları otomatik dolacak. Boş ise aşağıdaki kod akışı devam edecek.

                    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    //Referans numarası ekledikten sonra submit butonuna basınca Z_DowntimeDialog fragmentinin açılmasını sağlar. DamlaB
                    if (iv_reference) {
                        if (this.oDowntimeDialog == undefined) {
                            this.oDowntimeDialog = sap.ui.xmlfragment(
                                "Z_DowntimeDialog",
                        ...
                        this.PMNotification.fLocation =
                            iv_reference.Rowsets.Rowset.Row.FLOC_ID;
                        this.PMNotification.equipment =
                            iv_reference.Rowsets.Rowset.Row.EQUI_ID;
                        this.setDialogInputs_Enhancement();
						this.oDowntimeDialog.open();
					...
					this.resetStartEndTimeStamp();
                        ...
                        var startDate = new Date(
                            iv_reference.Rowsets.Rowset.Row.START_TIMESTAMP
                        );
                        var endDate = new Date(
                            iv_reference.Rowsets.Rowset.Row.END_TIMESTAMP
                        );
                        var pmWorkCenter = iv_reference.Rowsets.Rowset.Row.PM_WKCTR;
                        var convertedDate = endDate.getTime();
                        var startCovertedDate = startDate.getTime();
                        var startDateObject = new Date(startCovertedDate);
                        var dateObject = new Date(convertedDate);

                        //popupa start time ve end time set edilmesi sağlandı. -DAMLAB
                        ...
                        this.oDowntimeDialog.setModel(this.oDowntimeReportingModel);
                        this.oDowntimeReportingModel.refresh();
                        //Dakika cinsinden süre için ekleme yapıldı- DamlaB-290420220
                        this.setStartTime();
                        this.setEndTime();
                        //
                        this.oDowntimeDialog.setTitle(
                        ...
                        ////////////////////////////////////////////////damla
                        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                        //Submit butonuna basınca workunit, kesinti ve bildirim türünün otomatik gelmesini sağlar.-DAMLAB-1404
                        sap.ui.core.Fragment.byId(
                            "Z_DowntimeDialog",
                            "workunitforDowntime"
                        ).setText(
                            this.selectedDowntime.ioProductionRunDowntime.nodeDescription
                        );
                        //sap.ui.core.Fragment.byId(	"Z_DowntimeDialog","functionalLocation").setText(this.selectedDowntime.technicalObject[i].flocID);
                        sap.ui.core.Fragment.byId(
                            "Z_DowntimeDialog",
                            "checkPMNotification"
                        ).setSelected(true);
                            ...
                            if (this.selectedDowntime.technicalObject !== undefined) {
                                ...
                                oBindingInfo.factory = jQuery.proxy(function (sId, oContext) {
                                    ...
                                    var oTemplate = new sap.m.ColumnListItem({
                                        ...
                                        type: "Active",
                                        press: [this.handleOKForFLDialog_Enhancement, this],
                                    });
                        ...
                        if (results.outputCode != 1) {
                            if (results.customizationValues.results.length > 0) {
                                ...
                                if (
                                    ...
                                    sap.oee.ui.oeeConstants.dtTypes.LINEDOWN ||
                                    this.setSelectedMode ==
                                    sap.oee.ui.oeeConstants.dtTypes.FLOWTIME
                                ) {
                                ...
                                if (this.selectedDowntime.nodeId !== undefined) {
                                    if (this.selectedDowntime.technicalObject !== undefined) {
                                        ...
                                        oBindingInfo.factory = jQuery.proxy(function (
                                            sId,
                                            oContext
                                        ) {
                                            var oFloc = oContext.getProperty("flocID");
                    ...
                    ///Dakika cinsinden sürenin eklenmesi-damla
                    sap.oee.ui.Utils.calculateStartAndEndDatesWithDuration(
                        this.downtimeData,
                        sap.ui.core.Fragment.byId("Z_DowntimeDialog", "startDate"),
                        sap.ui.core.Fragment.byId("Z_DowntimeDialog", "startTime"),
                ...
                onChangeTypeDownTechObj: function (oEvent) {
                    ...
                    if (
                        ...
                        //if(sap.ui.core.Fragment.byId("Z_DowntimeDialog", "typeforDowntime").getSelectedKey() === "UNSCHEDULED_DOWN"){
                        this.downtimeData.crewSize = sap.ui.core.Fragment.byId(
                            "Z_DowntimeDialog",
                            "crewSizeforDowntime"
                        ).getValue();
                    ...
                    if (
                        ...
                        //if(sap.ui.core.Fragment.byId("Z_DowntimeDialog", "typeforDowntime").getSelectedKey() === "SCHEDULED_DOWN"){
                        this.downtimeData.standardDuration = sap.ui.core.Fragment.byId(
                            "Z_DowntimeDialog",
                            "standardDurationforDowntime"
                        ).getValue();
                ...
                onPressPMNotificationIcon: function (oEvent) {
                    ...
                    this.selectedPMNotification = items[0]
                        .getBindingContext()
                        .getObject();

                    this.checkStatusforNotification(
                        this.selectedPMNotification.oeeStatus
                    );
					this.PMNotificationDetailsDialog.open();
					

					//Kaan Adamey 28.09.2020 making action buttons invisible
					sap.ui.core.Fragment.byId(
						"PMNotificationDetailsDialog",
                ...
                onSelectNotification: function (oEvent) {
					//Kaan Adamey 28.09.2020 - disabling action buttons 
					/*
                ...
                onApproveNotification: function () {
                    ...
                    sap.oee.ui.Utils.toast(
                        this.appComponent.oBundle.getText(
                            "OEE_MESSAGE_TRIGGER_NOTIFICATION"
                        )
                    );
                },
            ...
            second parameter is for enabling/disabling  fields*/
                ...
                handleMicroStoppageAndFrequencyVisibility: function (
                    oMicro,
                    oFrequency
                ) {
                    this.initilizeInputFieldsForDowntimeDialog();
                ...
                handleFrequencyAndDurationBasedOnMicroStoppage: function (
                    ...
                    sap.ui.core.Fragment.byId("Z_DowntimeDialog", "frequency").setVisible(
                        oFrequencyVisible
                    );
                    sap.ui.core.Fragment.byId(
                        "Z_DowntimeDialog",
                    ...
                    sap.ui.core.Fragment.byId("Z_DowntimeDialog", "frequency").setValue(
                        oFrequencyValue
                    );
                    sap.ui.core.Fragment.byId(
                        "Z_DowntimeDialog",
                ...
                handleFieldVisibilityOfDowntimeDialog: function () {
                    ...
                    if (this.downtimeMode == "Edit") {
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    if (
                                        ...
                                        this.handleMicroStoppageAndFrequencyVisibility(
                                            false,
                                            false
                                        );
                                    }
                        ...
                        if (
                            ...
                            if (this.downtimeData.reasonCodeData.isFixed == "T") {
                                sap.ui.core.Fragment.byId(
                                    "Z_DowntimeDialog",
                                    "standardDurationforDowntime"
                                ).setEnabled(false);
                            ...
                            if (
                                ...
                                this.enableDisablePMNotifCheckBox();
                                this.handleImpactOrderVisibility(false);
                                // sap.ui.core.Fragment.byId("Z_DowntimeDialog", "checkPMNotification").setSelected(false);
                                sap.ui.core.Fragment.byId(
                                    "Z_DowntimeDialog",
                                    "downtimeDialog"
                                ).setContentHeight("70%");
                ...
                onApproveDialog: function () {
                    var oDialog = new Dialog({
                        ...
                        content: [
                            new Text({
                                text: "Referans ile bildirim açmak istiyor musunuz?",
                            }),
                            new sap.m.Input({
                                maxLength: 20,
                        ...
                        buttons: [
                            new Button({
                                ...
                                press: function () {
                                    ...
                                    var referanceNotificationId = sap.ui
                                        .getCore()
                                        .byId("InputBox1")
                                        .getValue();
                                    if (referanceNotificationId == "") {
                                        MessageToast.show("Referans Numarası Giriniz.");
                                        return;
                                    }
                                    that.getPMNotification(referanceNotificationId);

                                    //enhancementı çağır parametreye notificationidyi vererek
                                    //oDialog.close();
                                },
                            }),
                            new Button({
                                ...
                                text: "Devam Et",
                                press: function () {
                                    that.onPressReportNotification_Enhancement("");
                                    //enhancementı çağır parametreye boş vererek
                                    oDialog.close();
                                },
                            }),
                            new Button({
                    ...
                    oDialog.open();
                    //referans numarasına ait bilgilerin MPM_PMNOTIFY_HDR tablosundan çekilmesini sağlar. - Damla-Metin 10042020
                },
                getPMNotification: function (input1) {
                    var referanceNotificationId = input1;
                    var response = TransactionCaller.async(
                        "ItelliMES/UI/MANAGE_DOWNTIME/T_PM_NOTIFICATION",
                        { I_NOTIFICATIONID: referanceNotificationId },
                        "O_JSON",
                        this.getPMNotificationCB,
                        this
                    );
                },

                getPMNotificationCB: function (iv_data, iv_scope) {
                    //alert(iv_data[0]);
                    //this.referencePMData = iv_data;
                    if (iv_data[1] == "E") {
                        var errorData = iv_data[0];
                        MessageToast.show(errorData);
                        return;
                    }
                    that.onPressReportNotification_Enhancement(iv_data[0]);
                },
