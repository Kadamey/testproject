sap.ui.define(
	[
		...
		"orderCloseMessageKagitAdmin/scripts/transactionCaller",
	],
	function(
		jQuery,
		Controller,
		...
		return Controller.extend("orderCloseMessageKagitAdmin.controller.Main", {
			onInit: function() {
			...
			onConfirmPress: function onConfirmPress() {
				...
				var response = TransactionCaller.sync("ECZ_MES-4.0/KAGIT/podButtons/orderClose/adminClose/T_orderAdminClose", {
						I_SFC: SFC,
