...
oRouter,
        ...
        return Controller.extend("customOrderScreen.controller.usageDecision", {
            onInit: function () {
				oRouter = sap.ui.core.UIComponent.getRouterFor(this);
				oRouter.getRoute("RouteMain5").attachPatternMatched(this._onRoute, this);
			...
			_onRoute: function (oEvent) {
                ...
                SITE=oEvent.getParameter("arguments").PLANT;
 
				this.getQuarantineBobinData(SITE);
            ...
            getQuarantineBobinData: function (SITE) {
            ...
            getDialog1: function () {
                if (!this._oDialog) {
                    this._oDialog = sap.ui.xmlfragment(
                        "usageDecisionScreen_Add",
                        "customOrderScreen.view.fragments.usageDecisionScreen_Add",
                        this
                    );
                        ...
                        onClose: function (oAction) {
                            if (oAction == "OK") {
                                ...
                                if(scrapStatu == 1 & transferMaterialCodeStatu == 1|| scrapStatu == 0 & transferMaterialCodeStatu == 1){
                                    this.saveMaterialTransformation(transferMaterialCodeStatu);
                                }else if (scrapStatu == 1 & transferMaterialCodeStatu == 0){
            ...
            saveMaterialScrapValues: function () {
                ...
                if (ncCode == "" || ncCost == "" || usageDecision == "") {
                    ...
                    TransactionCaller.async(
					   ...
					   "ECZ_MES-4.0/KAGIT/usageDesicion_RFC/Queue_344/T_GoodsMovement",
                        {
                            I_BatchNumber: invId,
            ...
            saveMaterialTransformation: function (saveMaterialTransformation) {
...
"ECZ_MES-4.0/KAGIT/usageDesicion_RFC/Queue_344/T_GoodsMovement",
                        {
                            ...
                            I_ScrapQty: ncQty,
                            I_ScrapCostCenter: ncCost,
							I_TransferMatCodeStatu:saveMaterialTransformation,
		                    I_Plant:SITE
